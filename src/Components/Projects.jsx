...
const projects = [
  {
    ...
    title: "SkillSprint",
    description:
      "SkillSprint is a full-stack platform that helps students and developers discover hackathons, build or join teams, collaborate on projects, and showcase their skills—all in one centralized hub.",
