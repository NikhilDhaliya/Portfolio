  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full justify-end p-4 md:p-7">
        ...
        <p className="text-gray-400 text-xs md:text-sm mb-4 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-700 delay-200">
          {description}
        </p>
        <div className="flex gap-4 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-700 delay-100 flex-wrap">
          <a
            href={liveDemo}
            target="_blank"
