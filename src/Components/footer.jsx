...
const Footer = ({ homeRef }) => {
  return (
    <footer id="footer" className="bg-gradient-to-b from-[#10182b] to-[#182236] border-t border-[#232d3a] py-8 ">
      <div className="flex flex-col items-center gap-4">
        ...
        <nav className="flex gap-8 mb-2">
          <a
            ...
            href="#home"
            className="text-zinc-100 hover:text-sky-400 transition font-medium"
          >
            Home
          </a>
          <a
        ...
        {/* Contact Details */}
        <div className="flex flex-wrap gap-8 justify-center items-center text-zinc-300 text-sm mb-2">
          ...
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-sky-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h2.28a2 2 0 011.7.96l1.54 2.57a2 2 0 001.7.96h2.28a2 2 0 012 2v2.28a2 2 0 01-.96 1.7l-2.57 1.54a2 2 0 00-.96 1.7V19a2 2 0 01-2 2H5a2 2 0 01-2-2V5z" />
            </svg>
